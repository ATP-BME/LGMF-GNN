...
def main():
    ...
    distv = distance.pdist(features, metric='correlation')  # Use Pearson correlation distance to measure the degree of linear correlation between two vectors distances
