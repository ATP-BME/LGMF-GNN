...
class ABIDEDataset(InMemoryDataset):
    ...
    def processed_dir(self) -> str:
        ...
        if 'test' in self.raw_folder:
            ...
            # return osp.join(self.root, 'processed_corr_T1_same_protocol_test_corr')
            return osp.join(self.root, 'processed')
        
        else:
            print('using data:',osp.join(self.root,self.raw_dir,'processed'))
            return osp.join(self.root,self.raw_dir, 'processed')
        ...
        # return osp.join(self.root,'all_processed_corr_gdc')
